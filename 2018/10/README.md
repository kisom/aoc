...
points move slowly enough that it takes hours to align them, but have
so much momentum that they only stay aligned for a second. If you blink
...
this point's initial position were <3, 9>, after 3 seconds, its position
would become <6, 3>.
